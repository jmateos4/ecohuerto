...
import com.mcenteno.plantillas.dummy.DummyContent;
 ...
 */
public class HuertoListActivity extends Activity {
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(HuertoDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(HuertoDetailFragment.ARG_ITEM_ID, item.id);
